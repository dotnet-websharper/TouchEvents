...
function c(){ const fP=globalThis.document.getElementById("touchBox");const fQ=globalThis.document.getElementById("status");fP.addEventListener("touchstart", (fR) => { const fS=fR.touches.item(0);const fT=fP.getBoundingClientRect();d().Set(fS.clientX-fT.left);e().Set(fS.clientY-fT.top);fQ.textContent="Touch started!";});fP.addEventListener("touchmove", (fR) => { fR.preventDefault();const fS=fR.touches.item(0);fP.style.left=(fS.clientX-d().Get()).toFixed(6)+"px";fP.style.top=(fS.clientY-e().Get()).toFixed(6)+"px";fQ.textContent="Moving to: ("+fS.clientX.toFixed(6)+", "+fS.clientY.toFixed(6)+")";});fP.addEventListener("touchend", () => { fQ.textContent="Touch ended!";});}
...
class o extends i { i;k;h;s;static New_1(){ return new this("New_1");} constructor(fP){ if(fP=="New_1"){ let fQ;super();this.i=null;this.k=(fQ=C(),String(fQ));this.h=fH([]);fI(this, "s", null);} } }
function p(fP, fQ){ if(fP===fQ)return true;else { const fR=typeof fP;if(fR=="object"){ if(fP===null||fP===void 0||fQ===null||fQ===void 0||!p(typeof fQ, "object"))return false;else if("Equals"in fP)return fP.Equals(fQ);else if("Equals"in fQ)return false;else if(fP instanceof Array&&fQ instanceof Array)return q(fP, fQ);else if(fP instanceof Date&&fQ instanceof Date)return r(fP, fQ);else { const fS=[true];let fT;for(var fV in fP)if(((fW) => { fS[0]=!fP.hasOwnProperty(fW)||fQ.hasOwnProperty(fW)&&p(fP[fW], fQ[fW]);return!fS[0];})(fV))break;if(fS[0]){ let fU;for(var fW in fQ)if(((fX) => { fS[0]=!fQ.hasOwnProperty(fX)||fP.hasOwnProperty(fX);return!fS[0];})(fW))break;} return fS[0];} } else return fR=="function"&&("$Func"in fP?fP.$Func===fQ.$Func&&fP.$Target===fQ.$Target:"$Invokes"in fP&&"$Invokes"in fQ&&q(fP.$Invokes, fQ.$Invokes));} }
...
function A(fP){ H("index");return fP?I("index", G("main"), fP):void 0;}
function B(fP){ const fQ={};const fR=bO(fP);try { while(fR.MoveNext()){ const fS=fR.Current;fQ[fS[0]]=fS[1];} } finally { if(typeof fR=="object"&&a(fR))fR.Dispose();} return fQ;}
...
class E extends i { }
function F(fP, fQ, fR){ const fS=new u0030("New_5");const fT=new u0034("New_3");const fU=bO(fQ);try { while(fU.MoveNext()){ const fV=fU.Current;const fW=fV.Name;fT.SAdd(fW);fS.set_Item(fW, fV);} } finally { if(typeof fU=="object"&&a(fU))fU.Dispose();} return[u0035(fQ, bj((fX) => { const fY=fX[0];const fZ=fX[1];const f0=fX[2];if(fT.Contains(fY))return null;else { const f1=fZ===0?by.GetOrAddHoleFor(fP, fY, () => { const f2=f0==null?null:G(f0.$0);let f3=bA.Create_1(f2==null?"":f2.$0);return new bz(fY, f3);}):fZ===1?by.GetOrAddHoleFor(fP, fY, () => { const f2=f0==null?null:G(f0.$0);let f3=bA.Create_1(f2==null?0:f2.$0);return new bB(fY, f3);}):fZ===2?by.GetOrAddHoleFor(fP, fY, () => { const f2=f0==null?null:G(f0.$0);let f3=bA.Create_1(f2==null?false:f2.$0);return new bC(fY, f3);}):fZ===3?by.GetOrAddHoleFor(fP, fY, () => { const f2=f0==null?null:G(f0.$0);let f3=bA.Create_1(f2==null?-8640000000000000:f2.$0);return new bD(fY, f3);}):fZ===4?by.GetOrAddHoleFor(fP, fY, () => new bE(fY, bA.Create_1([]))):fZ===5?by.GetOrAddHoleFor(fP, fY, () => new bF(fY, bA.Create_1(G(globalThis.document.querySelector("[ws-dom="+fY+"]"))))):fZ===6?by.GetOrAddHoleFor(fP, fY, () => { const f2=f0==null?null:G(f0.$0);let f3=bA.Create_1(f2==null?[]:f2.$0);return new bG(fY, f3);}):f("Invalid value type");fS.set_Item(fY, f1);return G(f1);} }, fR)), {$:0, $0:fS}];}
...
function S(fP, fQ, fR, fS){ const fT=new u0034("New_3");function fU(f1, f2){ while(true)switch(f1){ case 0:if(f2!==null){ const f3=f2.nextSibling;if(p(f2.nodeType, Node.TEXT_NODE))cQ(f2);else if(p(f2.nodeType, Node.ELEMENT_NODE))fW(f2);f2=f3;} else return null;break;case 1:const f4=cY(f2.nodeName, G(3), null).toLowerCase();const f5=f4.indexOf(".");const f6=f5===-1?[fP, f4]:[cY(f4, null, G(f5-1)), cY(f4, G(f5+1), null)];const f7=f6[1];const f8=f6[0];if(f8!=""&&!M().ContainsKey(f8))return cR(f7);else { if(f8==""&&fS!=null)fS.$0(f7);const f9=M().Item(f8);if(!f9.ContainsKey(f7))return cR(f7);else { const f_=f9.Item(f7);const f$=f_.cloneNode(true);const ga=new u0034("New_3");const gb=new u0030("New_5");const gc=f2.attributes;for(let gm=0, gn=gc.length-1;gm<=gn;gm++){ const gd=gc.item(gm).name.toLowerCase();const ge=gc.item(gm).nodeValue;let gf=ge==""?gd:ge.toLowerCase();gb.set_Item(gd, gf);if(!ga.SAdd(gd))console.warn("Hole mapped twice", gd);} for(let go=0, gp=f2.childNodes.length-1;go<=gp;go++){ const gg=f2.childNodes[go];if(p(gg.nodeType, Node.ELEMENT_NODE))if(!ga.SAdd(gg.nodeName.toLowerCase()))console.warn("Hole filled twice", f7);} const gh=f2.childNodes.length===1&&p(f2.firstChild.nodeType, Node.TEXT_NODE);if(gh){ const gi=cS(f$, f2.firstChild.textContent, f7);const gj=((gq) =>(gr) => gq.SAdd(gr))(ga);let gk=((gq) =>(gr) => { if(gr!=null)gq(gr.$0);})((gq) => { gj(gq);});gk(gi);} cT(f$, ga);if(!gh){ for(let gq=0, gr=f2.childNodes.length-1;gq<=gr;gq++){ const gl=f2.childNodes[gq];if(p(gl.nodeType, Node.ELEMENT_NODE))if(gl.hasAttributes())cU(f$, gl);else fV(f$, gl);} } cV(f$, gb);cW(f$, f2.parentNode, f2);f2.parentNode.removeChild(f2);return;} } break;} } function fV(f1, f2){ const f3=f2.nodeName.toLowerCase();const f4=(f8, f9) => { if(f3=="title"&&f2.hasChildNodes()){ const f_=cZ(f2.textContent);f2.removeChild(f2.firstChild);while(f_.hasChildNodes())f2.appendChild(f_.firstChild);} fW(f2);return cW(f2, f8, f9);};V(f1, "[ws-attr-holes]", (f8) => { const f9=d0(f8.getAttribute("ws-attr-holes"), [" "], 1);for(let gb=0, gc=f9.length-1;gb<=gc;gb++){ const f_=k(f9, gb);let f$=new RegExp("\\${"+f3+"}", "ig");let ga=f8.getAttribute(f_).replace(f$, f2.textContent);f8.setAttribute(f_, ga);} });const f5=f1.querySelector("[ws-hole="+f3+"]");if(p(f5, null)){ const f6=f1.querySelector("[ws-replace="+f3+"]");if(p(f6, null)){ const f7=f1.querySelector("slot[name="+f3+"]");return f1.tagName.toLowerCase()=="template"?(f4(f7.parentNode, f7),void f7.parentNode.removeChild(f7)):null;} else { f4(f6.parentNode, f6);f6.parentNode.removeChild(f6);return;} } else { while(f5.hasChildNodes())f5.removeChild(f5.lastChild);f5.removeAttribute("ws-hole");return f4(f5, null);} } function fW(f1){ if(!f1.hasAttribute("ws-preserve"))if(d1(f1.nodeName.toLowerCase(), "ws-"))fY(f1);else { cX(f1);fX(f1.firstChild);} } function fX(f1){ return fU(0, f1);} function fY(f1){ return fU(1, f1);} function fZ(f1){ while(true){ const f2=f1.querySelector("[ws-template]");if(p(f2, null)){ const f3=f1.querySelector("[ws-children-template]");if(p(f3, null)){ const f4=f1.querySelectorAll("template[id]");for(let f_=1, f$=f4.length-1;f_<=f$;f_++){ const f5=f4[f_];if(fT.Contains(f5)){ } else { S(fP, G(f5.getAttribute("id")), f5, null);fT.SAdd(f5);} } const f6=f1.querySelectorAll("template[name]");for(let ga=1, gb=f6.length-1;ga<=gb;ga++){ const f7=f6[ga];if(fT.Contains(f7)){ } else { S(fP, G(f7.getAttribute("name")), f7, null);fT.SAdd(f7);} } return null;} else { const f8=f3.getAttribute("ws-children-template");f3.removeAttribute("ws-children-template");S(fP, G(f8), f3, null);f1=f1;} } else { const f9=f2.getAttribute("ws-template");(W(fP, G(f9), f2))(null);f1=f1;} } } const f0=(fQ==null?"":fQ.$0).toLowerCase();N(fP).set_Item(f0, fR);if(fR.hasChildNodes()){ fZ(fR);fX(fR.firstChild);} }
function T(fP, fQ){ let fR;const fS=[];const fT=[];const fU=[];const fV=[];const fW=new u0030("New_5");const fX=bO(fQ);try { while(fX.MoveNext()){ const fY=fX.Current;fW.set_Item(fY.Name, fY);} } finally { if(typeof fX=="object"&&a(fX))fX.Dispose();} let fZ=c0(fP);const f0=(f9, f_) => { const f$=dn(f9, f_);fT.push(do_1(f$));fU.push([f9, f$]);const ga=fJ(f$.OnAfterRender);if(ga==null)return null;else { const gb=ga.$0;fV.push(() => { gb(f9);});return;} };const f1=(f9) => { let f_;const f$=(f_=null,[fW.TryGetValue(f9, {get:() => f_, set:(gc) => { f_=gc;}}), f_]);if(f$[0]){ const ga=f$[1];if(ga instanceof dE)return G(ga.Value);else if(ga instanceof dF)return G(Z.TextNode(ga.Value));else { const gb=ga.ForTextView();return gb==null?null:G(Z.TextView(gb.$0));} } else return null;};V(fP, "[ws-hole]", (f9) => { const f_=f9.getAttribute("ws-hole");f9.removeAttribute("ws-hole");while(f9.hasChildNodes())f9.removeChild(f9.lastChild);const f$=f1(f_);if(f$!=null&&f$.$==1){ const ga=f$.$0;cg(f9, ga.docNode);fS.push(cA.New(dp(f9), ga.docNode, null, f9, cB(), null));fT.push(ga.updates);} });V(fP, "[ws-replace]", (f9) => { const f_=f1(f9.getAttribute("ws-replace"));if(f_!=null&&f_.$==1){ const f$=f_.$0;const ga=f9.parentNode;const gb=globalThis.document.createTextNode("");ga.replaceChild(gb, f9);const gc=cl(gb, f$.docNode);fZ=c0(fP);const gd=bk((ge) => f9===ge, fZ);if(gd==null){ } else l(fZ, gd.$0, f$.docNode);fS.push(cA.New(dp(ga), f$.docNode, G([gc, gb]), ga, cB(), null));fT.push(f$.updates);} });let f2=false;V(fP, "slot", (f9) => { const f_=f9.getAttribute("name");const f$=f_==""||f_==null?"default":f_.toLowerCase();if(f2&&f$=="default"||!p(fP.parentElement, null)){ } else { while(f9.hasChildNodes())f9.removeChild(f9.lastChild);if(f$=="default")f2=true;const ga=f1(f$);if(ga!=null&&ga.$==1){ const gb=ga.$0;cg(f9, gb.docNode);fS.push(cA.New(dp(f9), gb.docNode, null, f9, cB(), null));fT.push(gb.updates);} } });V(fP, "[ws-attr]", (f9) => { let f_;const f$=f9.getAttribute("ws-attr");f9.removeAttribute("ws-attr");const ga=(f_=null,[fW.TryGetValue(f$, {get:() => f_, set:(gc) => { f_=gc;}}), f_]);if(ga[0]){ const gb=ga[1];if(gb instanceof dG)f0(f9, gb.Value);else console.warn("Attribute hole filled with non-attribute data", f$);} });V(fP, "[ws-on]", (f9) => { f0(f9, dU.Concat(bj((f_) => { let f$;const ga=d0(f_, [":"], 1);const gb=(f$=null,[fW.TryGetValue(k(ga, 1), {get:() => f$, set:(gd) => { f$=gd;}}), f$]);if(gb[0]){ const gc=gb[1];return gc instanceof dH?G(dI(k(ga, 0), gc.Value)):gc instanceof dT?G(dU.Handler(k(ga, 0), gc.Value)):(console.warn("Event hole on"+k(ga, 0)+" filled with non-event data", k(ga, 1)),null);} else return null;}, d0(f9.getAttribute("ws-on"), [" "], 1))));f9.removeAttribute("ws-on");});V(fP, "[ws-onafterrender]", (f9) => { let f_;const f$=f9.getAttribute("ws-onafterrender");const ga=(f_=null,[fW.TryGetValue(f$, {get:() => f_, set:(gc) => { f_=gc;}}), f_]);if(ga[0]){ const gb=ga[1];if(gb instanceof dV){ f9.removeAttribute("ws-onafterrender");f0(f9, dJ(gb.Value));} else if(gb instanceof u0032){ f9.removeAttribute("ws-onafterrender");f0(f9, dJ(gb.Value));} else console.warn("onafterrender hole filled with non-onafterrender data", f$);} });V(fP, "[ws-var]", (f9) => { let f_;const f$=f9.getAttribute("ws-var");f9.removeAttribute("ws-var");const ga=(f_=null,[fW.TryGetValue(f$, {get:() => f_, set:(gb) => { f_=gb;}}), f_]);if(ga[0])ga[1].AddAttribute((gb) =>(gc) => f0(gb, gc), f9);});const f3=() => { X("[ws-dom]", (f9) => { let f_;let f$;let ga;const gb=(f_=null,[fW.TryGetValue(f9.getAttribute("ws-dom").toLowerCase(), {get:() => f_, set:(gf) => { f_=gf;}}), f_]);if(gb[0]){ const gc=gb[1];if(gc instanceof bF){ const gd=gc.Value;f9.removeAttribute("ws-dom");f$=f9;const ge=new MutationObserver((gf, gg) => { bo((gh) => { gh.removedNodes.forEach(fK((gi) => gi[0]===f$&&gh.addedNodes.length!==1?(gd.SetFinal(null),gg.disconnect()):null), null);}, gf);});if(f9.parentElement!==null)ge.observe(f9.parentElement, (ga={},ga.childList=true,ga));gd.Set(G(f9));cJ((gf) => { if(gf!=null&&gf.$==1){ const gg=gf.$0;if(f$===gg){ } else { f$.replaceWith(gg);f$=gg;} } else { f$.remove();ge.disconnect();} }, gd.View);} } });};V(fP, "[ws-attr-holes]", (f9) => { const f_=new RegExp(Y(), "g");const f$=d0(f9.getAttribute("ws-attr-holes"), [" "], 1);f9.removeAttribute("ws-attr-holes");for(let ga=0, gb=f$.length-1;ga<=gb;ga++)((() => { let gc;const gd=k(f$, ga);const ge=f9.getAttribute(gd);let gf=null;let gg=0;const gh=[];while(gf=f_.exec(ge),gf!==null){ const gi=cY(ge, G(gg), G(f_.lastIndex-k(gf, 0).length-1));gg=f_.lastIndex;gh.push([gi, k(gf, 1)]);} const gj=cY(ge, G(gg), null);f_.lastIndex=0;const gk=bp((gp, gq) =>(((gr) => { const gs=gr[0];const gt=gr[1];return(gu) => { let gv;const gw=gu[0];const gx=gu[1];const gy=(gv=null,[fW.TryGetValue(gt, {get:() => gv, set:(gA) => { gv=gA;}}), gv]);const gz=gy[0]?gy[1].AsChoiceView:dW("");return gz.$==1?[gs, dY.Cons(gw==""?gz.$0:cK((gA) => gA+gw, gz.$0), gx)]:[gs+gz.$0+gw, gx];};})(gp))(gq), gh, [gj, dY.Empty]);if(gk[1].$==1){ if(gk[1].$1.$==1){ if(gk[1].$1.$1.$==1){ if(gk[1].$1.$1.$1.$==0){ const gl=gk[0];gc=dK(gd, cL((gp, gq, gr) => gl+gp+gq+gr, gk[1].$0, gk[1].$1.$0, gk[1].$1.$1.$0));} else { const gm=gk[0];gc=dK(gd, cK((gp) => gm+dZ("", gp), cM(gk[1])));} } else { const gn=gk[0];gc=dK(gd, cN((gp, gq) => gn+gp+gq, gk[1].$0, gk[1].$1.$0));} } else if(gk[0]=="")gc=dK(gd, gk[1].$0);else { const go=gk[0];gc=dK(gd, cK((gp) => go+gp, gk[1].$0));} } else gc=dU.Create(gd, gk[0]);return f0(f9, gc);})());});let f4=fZ;const f5=fV.length==0?G(() => { f3();}):G((f9) => { f3();bo((f_) => { f_(f9);}, fV);});const f6=!p(fZ, null)&&fZ.length===1&&(k(fZ, 0)instanceof Node&&(k(fZ, 0)instanceof Element&&(fR=k(fZ, 0),true)))?G(fR):null;let f7={Els:f4, Dirty:true, Holes:fS, Attrs:fU, Render:f5?f5.$0:void 0, El:f6?f6.$0:void 0};let f8=fL(f7, ["Render", "El"]);return[f8, d7(cI(), cO, fT)];}
...
function u0036(fP){ const fQ=bO(fP);try { return fQ.MoveNext()?fQ.Current:c_();} finally { if(typeof fQ=="object"&&a(fQ))fQ.Dispose();} }
function u0037(fP, fQ, fR){ let fS=fQ;const fT=bO(fR);try { while(fT.MoveNext())fS=fP(fS, fT.Current);return fS;} finally { if(typeof fT=="object"&&a(fT))fT.Dispose();} }
function u0038(fP, fQ){ const fR=bO(fQ);try { while(fR.MoveNext())fP(fR.Current);} finally { if(typeof fR=="object"&&a(fR))fR.Dispose();} }
...
function bb(fP){ const fQ=bO(fP);try { if(!fQ.MoveNext())be();let fR=fQ.Current;while(fQ.MoveNext()){ const fS=fQ.Current;if(x(fS, fR)===1)fR=fS;} return fR;} finally { if(typeof fQ=="object"&&a(fQ))fQ.Dispose();} }
function bc(fP){ return{GetEnumerator:() => { const fQ=bO(fP);function fR(fS){ while(true){ const fT=fS.s;if(p(fT, null)){ if(fQ.MoveNext()){ fS.s=bO(fQ.Current);fS=fS;} else { fQ.Dispose();return false;} } else if(fT.MoveNext()){ fS.c=fT.Current;return true;} else { fS.Dispose();fS.s=null;fS=fS;} } } return new bS(null, null, fR, (fS) => { const fT=fS.s;if(!p(fT, null))fT.Dispose();if(!p(fQ, null))fQ.Dispose();});}};}
...
function bi(fP, fQ){ const fR=bO(fQ);try { let fS=false;while(!fS&&fR.MoveNext())fS=fP(fR.Current);return fS;} finally { if(typeof fR=="object"&&a(fR))fR.Dispose();} }
...
function bm(fP, fQ){ let fR=false;let fS=0;while(!fR&&fS<n(fQ))if(fP(fQ[fS]))fR=true;else fS=fS+1;return fR;}
...
function bs(fP){ if(fP instanceof Array)return fP.slice();else if(fP instanceof dY)return bu(fP);else { const fQ=[];const fR=bO(fP);try { while(fR.MoveNext())fQ.push(fR.Current);return fQ;} finally { if(typeof fR=="object"&&a(fR))fR.Dispose();} } }
...
function bv(fP, fQ){ let fR=true;let fS=0;while(fR&&fS<n(fQ))if(fP(fQ[fS]))fS=fS+1;else fR=false;return fR;}
...
function bU(fP, fQ, fR){ const fS=fP.s;if(fS==null)fR();else fS!=null&&fS.$==2?(fS.$1.push(fR),fQ(fS.$0)):fS!=null&&fS.$==3?(fS.$0.push(fQ),fS.$1.push(fR)):fQ(fS.$0);}
...
function b1(fP, fQ){ const fR=fP.s;if(fR==null)fQ();else fR!=null&&fR.$==2?fR.$1.push(fQ):fR!=null&&fR.$==3?fR.$1.push(fQ):void 0;}
function b2(fP, fQ, fR){ const fS=fP.s;if(fS==null)dm(fR);else fS!=null&&fS.$==2?(ce(fS.$1, fR),fQ(fS.$0)):fS!=null&&fS.$==3?(fS.$0.push(fQ),ce(fS.$1, fR)):fQ(fS.$0);}
...
function b$(fP, fQ){ const fR=fP.s;if(fR!=null&&fR.$==3){ fP.s=cF(fQ);const fS=fR.$0;for(let fT=0, fU=n(fS)-1;fT<=fU;fT++)(k(fS, fT))(fQ);} else void 0;}
function ca(fP, fQ){ const fR=fP.s;if(fR!=null&&fR.$==3){ fP.s=cE(fQ, fR.$1);const fS=fR.$0;for(let fT=0, fU=n(fS)-1;fT<=fU;fT++)(k(fS, fT))(fQ);} else void 0;}
function cb(fP, fQ, fR){ return bV((fS) => fP(fQ, fS), fR);}
function cc(fP, fQ, fR){ return bV((fS) => fP(fS, fQ), fR);}
function cd(fP, fQ){ const fR=fP.s;if(fR==null)dm(fQ);else fR!=null&&fR.$==2?ce(fR.$1, fQ):fR!=null&&fR.$==3?ce(fR.$1, fQ):void 0;}
...
function cj(fP, fQ, fR){ if(dc()){ const fS=null;return ei(() => { const fT=ec(fR);const fU=cr(fQ, fT);const fV=cq(fQ, fT);return ej(dd(de(fU, cp(fQ, fT))), () => ej(co(fP, fQ), () => ej(dd(fV), () => { fQ.PreviousNodes=fT;return em(null);})));});} else return co(fP, fQ);}
...
function cz(fP){ const fQ=fP.El;function fR(fV, fW){ while(true){ if(fV!=null&&fV.$==1)return fV.$0.El;else if(fV!=null&&fV.$==2){ const fX=fV.$0;if(fX.Dirty){ fX.Dirty=false;return ch(fQ, fX.Current, fW);} else fV=fX.Current;} else if(fV==null)return fW;else if(fV!=null&&fV.$==4)return fV.$0.Text;else if(fV!=null&&fV.$==5)return fV.$0;else if(fV!=null&&fV.$==6){ const fY=fV.$0;if(fY.Dirty)fY.Dirty=false;return bp((f1, f2) => f1==null||f1.constructor===Object?fR(f1, f2):f1, fY.Els, fW);} else { const fZ=fV.$1;const f0=fV.$0;fV=f0;fW=fR(fZ, fW);} } } const fS=fP.El;ft((fV) => { c9(fS, fV);}, fs(fu(fP), fr(fP.El, fJ(fP.Delimiters))));let fT=fP.Children;const fU=fJ(fP.Delimiters);fR(fT, fU!=null&&fU.$==1?fU.$0[1]:null);}
...
class cH extends Z { docNode_1;updates_1;elt;rvUpdates;static TreeNode(fP, fQ){ const fR=d_.Create(fQ);const fS=bq((fV) => do_1(fV[1]), fP.Attrs);let fT=d7(cI(), cO, fS);let fU=cO(fT, fR.v);return new cH(bI(fP), fU, k(fP.Els, 0), fR);} constructor(fP, fQ, fR, fS){ super(fP, fQ);this.docNode_1=fP;this.updates_1=fQ;this.elt=fR;this.rvUpdates=fS;} }
...
function cY(fP, fQ, fR){ if(fQ==null){ if(fR!=null&&fR.$==1){ const fS=fR.$0;return fS<0?"":fP.slice(0, fS+1);} else return"";} else if(fR==null)return fP.slice(fQ.$0);else { const fT=fR.$0;return fT<0?"":fP.slice(fQ.$0, fT+1);} }
...
function c$(fP, fQ){ let fR=true;let fS=0;while(fR&&fS<n(fQ))if(p(fQ[fS], fP))fR=false;else fS=fS+1;return!fR;}
...
function dd(fP){ const fQ=null;return ei(() => ej(df(() => { }, eu(fP)), () => { ev(fP);return em(null);}));}
...
function dk(fP){ const fQ=[0];function fR(){ const fS=null;return ei(() => ej(fP, () => { const fT=fQ[0];return p(fT, 1)?(fQ[0]=0,ek()):p(fT, 2)?(fQ[0]=1,fR()):ek();}));} return() => { const fS=fQ[0];if(p(fS, 0)){ fQ[0]=1;el(fR(), null);} else p(fS, 1)?fQ[0]=2:void 0;};}
...
class dU { static Handler(fP, fQ){ return dU.HandlerImpl(fP, fQ);} static Concat(fP){ const fQ=d9(fP);return d7(dt(), dU.Append, fQ);} static Create(fP, fQ){ return dr((fR) => { fR.setAttribute(fP, fQ);});} static HandlerImpl(fP, fQ){ return dr((fR) => { fR.addEventListener(fP, (fS) =>(fQ(fR))(fS), false);});} static Append(fP, fQ){ return dA(fP, fQ);} static A4(fP){ return fN(dU, {$:4, $0:fP});} static A3(fP){ return fN(dU, {$:3, $0:fP});} static A1(fP){ return fN(dU, {$:1, $0:fP});} static A2(fP, fQ){ return fN(dU, {$:2, $0:fP, $1:fQ});} }
...
class dY { static Cons(fP, fQ){ return fN(dY, {$:1, $0:fP, $1:fQ});} static Empty=fN(dY, {$:0});GetEnumerator(){ return new bS(this, null, (fP) => { const fQ=fP.s;return fQ.$==0?false:(fP.c=fQ.$0,fP.s=fQ.$1,true);}, void 0);} }
...
function d9(fP){ if(fP instanceof Array)return fP;else if(fP instanceof dY)return bu(fP);else if(fP===null)return[];else { const fQ=[];const fR=bO(fP);try { while(fR.MoveNext())fQ.push(fR.Current);return fQ;} finally { if(typeof fR=="object"&&a(fR))fR.Dispose();} } }
...
class fp { get Input(){ return this.$==1?this.$0:this.$==2?this.$0:this.$1;} static Blank(fP){ return fN(fp, {$:2, $0:fP});} static Invalid(fP){ return fN(fp, {$:1, $0:fP});} static Valid(fP, fQ){ return fN(fp, {$:0, $0:fP, $1:fQ});} }
class fq extends i { init;c;pending;r;constructor(){ super();this.c=false;this.pending=null;this.r=[];this.init=1;} }
function fr(fP, fQ){ let fR;if(fQ!=null&&fQ.$==1){ const fS=[];fR=fQ.$0[0].nextSibling;while(fR!==fQ.$0[1]){ fS.push(fR);fR=fR.nextSibling;} return fv(fS);} else { let fT=fP.childNodes.length;const fU=fP.childNodes;let fV=bx(fT, (fW) => fU[fW]);return fv(fV);} }
...
class fz extends Error { ct;static New(fP){ return new this("New", fP);} static New_1(fP, fQ, fR){ return new this("New_1", fP, fQ, fR);} constructor(fP, fQ, fR, fS){ let fT;if(fP=="New"){ fT=fQ;fP="New_1";fQ="The operation was canceled.";fR=null;fS=fT;} if(fP=="New_1"){ const fU=fQ;const fV=fR;const fW=fS;super(fU);this.inner=fV;this.ct=fW;} } }
