...
class dY { static Cons(fP, fQ){ return fN(dY, {$:1, $0:fP, $1:fQ});} static Empty=fN(dY, {$:0});GetEnumerator(){ return new bS(this, null, (fP) => { const fQ=fP.s;if(fQ.$==0)return false;else { const fR=fQ.$1;fP.c=fQ.$0;fP.s=fR;return true;} }, void 0);} }
